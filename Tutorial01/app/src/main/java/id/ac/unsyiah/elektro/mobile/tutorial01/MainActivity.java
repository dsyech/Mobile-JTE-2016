...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickTerjemahkan (View view){
        ...
        if (bahasaIndonesia==false) {
            ...
            String terjemahkanIndo = getString(R.string.terjemahkanIndo);
            btnTerjemahkan.setText(terjemahkanIndo);
            ...
            String terjemahkanEng = getString(R.string.TerjemahkanEng);
            btnTerjemahkan.setText(terjemahkanEng);
