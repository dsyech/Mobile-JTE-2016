package id.ac.unsyiah.elektro.mobile.kalkulatorradio;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickRadioButton (View view){
        ...
        EditText numAngka1 = (EditText) findViewById(R.id.angka1);
        String angka1Str = numAngka1.getText().toString();
        float angka1 = Long.valueOf(angka1Str);

        EditText numAngka2 = (EditText) findViewById(R.id.angka2);
